        ...
        {postProps.posts?.map((post) => {
          return (
            <>
              ...
              <div className="text-gray-500 text-lg mb-6 mx-3 px-2">
                ...
                {postProps.isUpdating ? (
                  <textarea
                    ...
                    onChange={(e) => postProps.setTomorrowText(e.target.value)}
                    placeholder="Type something here..."
                    className="w-full rounded-lg p-2 text-sm bg-gray-100 border border-transparent appearance-none rounded-tg placeholder-gray-400 h-24"
                  ></textarea>
                ) : (
              ...
              <div className="text-gray-500 text-lg mb-6 mx-3 px-2">
                <h1 className="font-semibold">What blockers do you have?</h1>
                {postProps.isUpdating ? (
                  <textarea
                    name="blockersText"
                    value={postProps.blockersText}
                    onChange={(e) => postProps.setBlockersText(e.target.value)}
                    placeholder="Type something here..."
                    className="w-full rounded-lg p-2 text-sm bg-gray-100 border border-transparent appearance-none rounded-tg placeholder-gray-400 h-24"
                  ></textarea>
                ) : (
                ...
                >
                  <span className="transition ease-out duration-300 hover:bg-gray-50 bg-gray-100 h-8 px-1 py-1 text-center rounded-full cursor-pointer">
                    ...
                    {post?.likes?.includes(user?._id) ? (
                      <AiFillLike size={'1.5em'} className="text-blue-400" />
                    ) : (
                      <AiOutlineLike size={'1.5em'} className="text-blue-400" />
                    )}
                  </span>
                </div>
              </div>
