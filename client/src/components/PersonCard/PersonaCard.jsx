    ...
    <>
      <div className="shadow-lg shadow-purple-200 p-4 w-full md:w-96 h-52 rounded bg-gradient-to-bl from-blue-300 to-blue-900 flex flex-col justify-center items-center mt-4 max-w-[24rem]">
        <img
          ...
          alt="logo"
        />
        <p className="text-gray-100 font-semibold">Bryce Henderson</p>
        <button className="w-full rounded-md bg-blue-500  py-2 text-indigo-100 hover:bg-blue-700 hover:shadow-md duration-75 mt-8">
          Add to Contacts
        </button>
      </div>
